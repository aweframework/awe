...
(
    ...
    l1_nom  varchar(20),                           --  User name
    l1_pas  varchar(40),                           --  User password hash
    OpePas  varchar(200),                          --  User password hash (old)
    l1_con  int      DEFAULT 0,                 --  Connected (1) or not (0)
    l1_dev  varchar(3),                            --  unused
    l1_act  int      DEFAULT 1,                 --  Active (1) or not (0)
    l1_trt  varchar(1),                            --  unused
    l1_uti  int,                                --  unused
    l1_opr  varchar(6),                            --  unused
    l1_dat  DATE,                               --  Last connection date
    imp_nom varchar(32) DEFAULT 'none',
    dat_mod datetime,                           --  User update date
    l1_psd  datetime,                           --  Date of password expiration
    l1_lan  varchar(3),                            --  User language
...
(
    ...
    HISact  varchar(1)   not NULL,
    IdeOpe  int          NULL,
    l1_nom  varchar(20)     NULL,
    l1_pas  varchar(40)     NULL,
    OpePas  varchar(200)    NULL,
    l1_con  int          NULL,
    l1_dev  varchar(3)      NULL,
    l1_act  int          NULL,
    l1_trt  varchar(1)      NULL,
    l1_uti  int          NULL,
    l1_opr  varchar(6)      NULL,
    l1_dat  date         NULL,
    imp_nom varchar(32)     NULL,
    dat_mod date         NULL,
    l1_psd  date         NULL,
    l1_lan  varchar(3)      NULL,
    l1_sgn  int          NULL,
...
--  DDL for CONSTRAINTS
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
ALTER TABLE AwePro ADD CONSTRAINT IF NOT EXISTS fk_AwePro1 FOREIGN KEY (IdeThm) REFERENCES AweThm (IdeThm);
ALTER TABLE AwePro ADD CONSTRAINT IF NOT EXISTS uq_AwePro UNIQUE (Acr);
ALTER TABLE ope ADD CONSTRAINT IF NOT EXISTS fk_ope1 FOREIGN KEY (IdePro) REFERENCES AwePro (IdePro);
ALTER TABLE ope ADD CONSTRAINT IF NOT EXISTS fk_ope2 FOREIGN KEY (IdeThm) REFERENCES AweThm (IdeThm);
ALTER TABLE AweMod ADD CONSTRAINT IF NOT EXISTS fk_AweMod1 FOREIGN KEY (IdeThm) REFERENCES AweThm (IdeThm);
ALTER TABLE AweSitModDbs ADD CONSTRAINT IF NOT EXISTS fk_AweSitModDbs1 FOREIGN KEY (IdeSit) REFERENCES AweSit (IdeSit);
...
CREATE TABLE IF NOT EXISTS tst_order
(
...
CREATE TABLE IF NOT EXISTS tst_order_item
(
    id INTEGER AUTO_INCREMENT PRIMARY KEY,
