package com.almis.awe.scheduler.component;
 ...
 */
public class SchedulerTaskLogEvaluator extends EventEvaluatorBase<ILoggingEvent> {

  public boolean evaluate(ILoggingEvent event) throws NullPointerException, EvaluationException {
    Map<String, String> mdc = event.getMDCPropertyMap();
    return mdc.get("logByTaskExecution") != null;
  }
}
