...
public class XStreamSerializer {
   ...
   */
  public <T> void writeXmlFromObject(Object object, OutputStream outputStream) {
    try {
   ...
   */
  public synchronized <T> void writeXmlFromObject(Class<T> wrapperClass, Object object, Writer writer) {
    try {
      // Process annotations
   ...
   * @param object       Object to serialize
   */
  public <T> String writeStringFromObject(Object object) {
    String output = null;
    try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
      writeXmlFromObject(object, outputStream);
   ...
   */
  public synchronized <T> T getObjectFromXml(Class<T> wrapperClass, Reader reader) {
    T object = null;
    try {
      // Process annotations
      xmlXStreamMarshaller.getXStream().processAnnotations(wrapperClass);
