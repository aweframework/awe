...
describe('awe-framework/awe-client-angular/src/test/jest/components/loader.js', function () {
    ...
    it('try to initialize as component', function () {
        ...
        jest.spyOn(ServerData, "preloadAngularTemplate").mockImplementation((a, fn) => fn());
    ...
    it('try to initialize with a loading template', function () {
        ...
        jest.spyOn($storage, "get").mockReturnValue({'base': {}});
        jest.spyOn(ServerData, "preloadAngularTemplate").mockImplementation((a, fn) => fn());
        jest.spyOn($templateCache, "get").mockReturnValue("--LOADING--");
        jest.spyOn($rootScope, "$on").mockImplementation((a, fn) => {
            setTimeout(fn, 0);
            return function() {};
        });
    ...
    it('try to initialize with a loaded template', function () {
        ...
        jest.spyOn($storage, "get").mockReturnValue({'base': {}});
        jest.spyOn(ServerData, "preloadAngularTemplate").mockImplementation((a, fn) => fn());
        jest.spyOn($templateCache, "get").mockReturnValue("Loaded template");
