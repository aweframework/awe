...
describe('awe-framework/awe-client-angular/src/test/jest/filters/tests.js', function() {
  ...
  it('should translate a value', function() {
    // Arrange
    let textToTranslate = "text to  translate";
    jest.spyOn($translate, "instant").mockImplementation((text) => {
      switch (text) {
        case "text":
          return "LALA";
        case "to":
  ...
  it('should format a number', function() {
    ...
    jest.spyOn($settings, "getLanguage").mockReturnValue('ES');
