...
describe("awe-framework/awe-client-angular/src/test/jest/contracts/booleanFamily/boolean.contract.js", function () {
  let $injector;
  let $rootScope;
  let $control;
  let CheckboxRadio;
  ...
  describe("buttonCheckbox contract", function () {
    ...
    it("treats string-matched payloads as checked without coercing the serialized value", function () {
      ...
      expect(buttonCheckbox.scope.checked).toBe(true);
