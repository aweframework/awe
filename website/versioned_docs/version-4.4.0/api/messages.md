...
Message elements are messages to show after execute one action. Usually these message are described in the hidden
...
|`title`| String | **Required**| Is the title of message | **
