---
id: wizard-and-wizard-panel title: Wizard and Wizard panel
---

## Introduction

A **wizard** or **assistant** is a very useful screen component to guide the user through an ordered group of screens
called *steps*:
...
<wizard id="[wizard-identifier]" initial-load="[initial-load]" target-action="[target-action]"
...
| ----------- | ------------ |-----------|-----------------------------|----------------------------------------------------|
| id          | **
Required** | String    | Wizard identifier. For reference purposes |                                   |
| label       | Optional     | String    | Wizard step text (without the number) | **
...
| ----------- | ------------ |-----------|-----------------------------|----------------------------------------------------|
| id          | **
Required** | String    | Panel identifier. Must be the same as target values |                                   |
